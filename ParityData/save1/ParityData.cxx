...
// Bit pattern for trigger definition
   ...
   for (UInt_t i = 0; i < bits.GetNbits(); i++) {
     fCrateLoc.push_back(new BdataLoc(Form("bit%d",i+1), 3, (Int_t) 11, 48+i));
   }

   fCrateLoc.push_back(new BdataLoc("upQadcL", 3, 23, 16)); 
   fCrateLoc.push_back(new BdataLoc("upQadcR", 1, 25, 40)); 
   fCrateLoc.push_back(new BdataLoc("loQadcL", 3, 23, 20)); 
   fCrateLoc.push_back(new BdataLoc("loQadcR", 1, 25, 36)); 

   fCrateLoc.push_back(new BdataLoc("upQtdcL", 4, 13, 84)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("upQtdcR", 2, 14, 84)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("loQtdcL", 4, 13, 80)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("loQtdcR", 2, 14, 80)); // Ahmed.

   fCrateLoc.push_back(new BdataLoc("atQadcL", 3, 23, 22)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("atQadcR", 1, 25, 39)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("atQtdcL", 4, 13, 86)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("atQtdcR", 2, 14, 85)); // Ahmed.

   fCrateLoc.push_back(new BdataLoc("hapadcL", 3, 25, 38));  // 7th chan.
   fCrateLoc.push_back(new BdataLoc("hapadcR", 1, 25, 32));  // 1st chan.
   fCrateLoc.push_back(new BdataLoc("haptdcL", 4, 13, 86));
   fCrateLoc.push_back(new BdataLoc("haptdcR", 1, 14, 80));

   fCrateLoc.push_back(new BdataLoc("upSadcL", 3, 23, 18)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("upSadcR", 1, 25, 34)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("upStdcL", 4, 13, 82)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("upStdcR", 2, 14, 82)); // Ahmed.

   fCrateLoc.push_back(new BdataLoc("loSadcL", 3, 23, 19)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("loSadcR", 1, 25, 35)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("loStdcL", 4, 13, 83)); // Ahmed.
   fCrateLoc.push_back(new BdataLoc("loStdcR", 2, 14, 83)); // Ahmed.

   fCrateLoc.push_back(new BdataLoc("amp1", 1, 25, 1));
   fCrateLoc.push_back(new BdataLoc("bamp", 1, 25, 15));

//    fCrateLoc.push_back(new BdataLoc("s0La", 3, 23, 16));
//    fCrateLoc.push_back(new BdataLoc("s0Lb", 3, 23, 22));
//    fCrateLoc.push_back(new BdataLoc("s0Ra", 1, 25, 0));
//    fCrateLoc.push_back(new BdataLoc("s0Rb", 1, 25, 6));

   fCrateLoc.push_back(new BdataLoc("s0La", 3, 25, 16));
   fCrateLoc.push_back(new BdataLoc("s0Lb", 3, 25, 22));
   fCrateLoc.push_back(new BdataLoc("s0Ra", 1, 25, 0));
   fCrateLoc.push_back(new BdataLoc("s0Rb", 1, 25, 8));

   // Quartz moved from 2nd to 4th chan, Aug 24
   fCrateLoc.push_back(new BdataLoc("Apscint", 1, 25, 34));
   fCrateLoc.push_back(new BdataLoc("Aquartz", 1, 25, 35));
   fCrateLoc.push_back(new BdataLoc("Tpscint", 1, 14, 82));
   fCrateLoc.push_back(new BdataLoc("Tquartz", 1, 14, 83));

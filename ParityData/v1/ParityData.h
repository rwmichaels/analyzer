...
private:
   ...
   Double_t amp1, bamp; // Ahmed.

   // HAPPEX detector ADC and TDC
   Double_t hapadcL,hapadcR;
   Double_t haptdcL,haptdcR;

   // UMass PREX detectors (quartz, scint)
   Double_t Aquartz, Tquartz;     // ADC, TDC
   Double_t Apscint, Tpscint;   // ADC, TDC
 
   // S0 detector used in trigger
